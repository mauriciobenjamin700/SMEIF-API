...
def test_student_uc_delete_parent_success(
    db_session: Session,
    ...
    response = StudentUseCases(db_session).delete_parent(
...
def test_StudentUseCases_delete_parent_fail_no_parent(
    db_session: Session,
    mock_student_on_db
):
...
def test_StudentUseCases_delete_parent_fail_no_student(
    db_session: Session,
    mock_parent_on_db,
    mock_student_on_db
):
...
def test_StudentUseCases_delete_parent_fail_min_parent(
    db_session: Session,
    mock_student_on_db,
    mock_parent_on_db
):
...
def test_StudentUseCases_delete_parent_fail_another_parent(
    db_session: Session,
    mock_student_on_db_with_max_parents,
    mock_parent_on_db,
