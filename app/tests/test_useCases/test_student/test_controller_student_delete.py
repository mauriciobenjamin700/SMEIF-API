...
def test_StudentUseCases_delete_success(
    db_session: Session,
    mock_student_on_db,
):
...
def test_StudentUseCases_delete_success_unformat_cpf(
    db_session: Session,
    mock_student_on_db,
):
...
def test_StudentUseCases_delete_fail_not_found(
    db_session: Session,
    mock_student_on_db,
):
