...
def test_controller_classes_add_recurrences_success_two(
    db_session,
    ...
    response = controller.add_recurrences(
...
def test_controller_classes_add_recurrences_success_one(
    db_session,
    mock_class_event_on_db,
    mock_Recurrences_list
):
...
def test_controller_classes_add_recurrences_fail_conflict(
    db_session,
    mock_class_event_on_db,
    mock_Recurrences_list
):
