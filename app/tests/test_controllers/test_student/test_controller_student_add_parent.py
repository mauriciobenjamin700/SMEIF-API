...
def test_StudentController_add_parent_fail_invalid_kinship(
    db_session: Session,
    mock_student_on_db,
    mock_new_parent_on_db
):
...
def test_StudentController_add_parent_fail_no_parent_in_db(
    db_session: Session,
    mock_student_on_db
):
...
def test_StudentController_add_parent_fail_child_student_in_db(
    db_session: Session,
    mock_new_parent_on_db
):
...
def test_StudentController_add_parent_fail_parent_student_in_db(
    db_session: Session,
    mock_student_on_db
):
...
def test_StudentController_add_parent_fail_max_parent(
    db_session: Session,
