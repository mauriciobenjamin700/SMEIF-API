...
def test_StudentController_change_class_success_transfer(
    db_session: Session,
    mock_student_on_db,
    ...
    response = controller.change_class(
...
def test_StudentController_change_class_success_aloc(
    db_session: Session,
    mock_student_on_db,
    mock_class_on_db
):
...
def test_StudentController_change_class_fail_invalid_cpf(
    db_session: Session,
    mock_student_on_db,
    mock_new_class_on_db
):
...
def test_StudentController_change_class_fail_empty_to_class_id(
    db_session: Session,
    mock_student_on_db,
):
...
def test_StudentController_change_class_fail_not_found_child(
    db_session: Session,
    mock_student_on_db,
    mock_new_class_on_db
):
...
def test_StudentController_change_class_fail_not_found_class_id(
    db_session: Session,
    mock_student_on_db
):
...
def test_StudentController_change_class_fail_transfer_to_same_class(
    db_session: Session,
    mock_student_on_db,
    mock_class_on_db
):
